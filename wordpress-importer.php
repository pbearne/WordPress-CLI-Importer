...
class WP_Import extends WP_Importer {
	...
	// Specific to phenomena import
	var $forced_author_id = 16804;
	var $mini_blog_id = 74;
	...
	function import( $file ) {
		...
		$this->mini_blog = CF_Mini_Blog::factory();
	...
	function process_posts() {
		foreach ( $this->posts as $post ) {
			...
			if ( $post_exists && get_post_type( $post_exists ) == $post['post_type'] ) {
				...
				// map the post author
				$author = (int) $this->forced_author_id;
				...
				$this->mini_blog->set_mini_blog_term($post_id, $this->mini_blog_id);
